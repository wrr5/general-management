...
type Express struct {
	...
	ActualQuantity float64   `gorm:"column:actual_quantity;type:decimal(15,4);not null;comment:实到数量"`
	HasArrived     int8      `gorm:"column:has_arrived;type:tinyint;default:0;index:idx_has_arrived;comment:是否已到（0未到，1已到）"`
...
// 状态常量
const (
	ExpressStatusNotArrived = 0 // 未到
	ExpressStatusArrived    = 1 // 已到
